...
namespace StudentCourse.Models
{
    public class StudentCourseMetoder
    {
        ...
        /*
        public List<StudentCourseDetalj> SortStudentCourseWithDataSet(out string errormsg)
        {
            //Skapa  SqlConnection
            SqlConnection dbConnection = new SqlConnection();
        ...
        */
        public List<StudentCourseDetalj> SortStudentCourseWithDataSet(out string errormsg, string sort)
        {
            ...
            //Sqlstring och för att hämta alla studenter
            string sqlstring = "SELECT * FROM Tbl_Student, Tbl_StudentCourse, Tbl_Course WHERE Tbl_StudentCourse.St_Id = Tbl_Student.St_Id AND Tbl_StudentCourse.Co_Id = Tbl_Course.Co_Id AND Tbl_Course.Co_Id = @sortId ORDER BY Tbl_Course.Co_Name";
            SqlCommand dbCommand = new SqlCommand(sqlstring, dbConnection);
